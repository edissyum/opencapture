...
let DropDownBase = class DropDownBase extends Component {
    ...
    renderSelectElement(selectElement, listData) {
        let isDataSource = this.dataSource instanceof Array ? (this.dataSource.length > 0 ? true : false)
            : !isNullOrUndefined(this.dataSource) ? true : false;
...
let DropDownTree = class DropDownTree extends Component {
     ...
     */
    render() {
        const isTree = document.querySelector('#' + this.element.id + '_tree');
        if (isTree) {
            const popupDiv = document.querySelector('#' + this.element.id + '_popup');
