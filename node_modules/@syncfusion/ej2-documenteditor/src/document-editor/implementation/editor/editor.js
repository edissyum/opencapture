...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.skipCommentCharacter = function (inline) {
        ...
        var insertPosition = curentHistoryInfo.insertPosition;
        var startPos = curentHistoryInfo.selectionStart;
        var endPos = curentHistoryInfo.selectionEnd;
    ...
    Editor.prototype.updateFootNoteIndex = function () {
        ...
        for (var i = 0; i < footNoteCollec.length; i++) {
            ...
            footNoteCollec[i].blocks[0].childWidgets[0].children[0].text = (i + 1).toString();
        }
    };
    return Editor;
}());
