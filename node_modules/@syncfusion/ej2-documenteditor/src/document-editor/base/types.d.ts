 ...
 * @private
 */
export declare type TablePasteOptions = 'InsertAsRows' | 'NestTable' | 'InsertAsColumns' | 'OverwriteCells' | 'DefaultPaste';
/**
 ...
 */
export declare type CompatibilityMode = 'Word2003' | 'Word2007' | 'Word2010' | 'Word2013';
