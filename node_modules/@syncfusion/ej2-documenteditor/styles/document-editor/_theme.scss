@include export-module('documenteditor-theme') {
    ...
    .e-de-ff-radio-div {
        display: inline-flex;
        margin-bottom: $de-ff-radio-div-mrgn-btm;
        margin-right: 16px;
    }
    ...
    .e-de-toc-dlg-main-heading {
        ...
        margin-bottom: $de-toc-title-bottom-margin !important;
    ...
    .e-de-table-options-dlg-div {
        ...
        .e-bigger {
            ...
            .e-de-toc-label {
                margin-left: $de-toc-lbl-mrgn-left;
            }
            .e-de-toc-label-rtl {
                margin-left: 0px;
                margin-right: $de-toc-lbl-mrgn-rgt;
            }
            .e-de-outline-rtl {
                width: 173px;
            }
        ...
        .e-de-rp-btn-enforce {
            ...
            height: 36px;
            margin: 0 $de-rp-btn-enforce-margin !important;
            @if $skin-name=='bootstrap4' {
        ...
        .e-btn.e-outline.e-de-track-accept-button:hover {
            border-color: transparent;
            background-color: $de-track-chngs-sucs-bg-color;
            color: #fff;
            padding: 5px $de-tc-btn-padding;
            text-transform: initial;
            width: 66px;
        ...
        .e-btn.e-outline.e-de-track-reject-button {
            border-color: $de-track-chngs-rejct-bg-color;
            background-color: transparent;
        ...
        .e-btn.e-outline.e-de-track-reject-button:hover {
            border-color: transparent;
            background-color: $de-track-chngs-rejct-bg-color;
            color: #fff;
            padding: 5px 6px;
            margin-left: 8px;
            text-transform: initial;
