 ...
 * @hidden
 */
export declare function moveSheet(context: Workbook, position: number, sheetIndexes?: number[], action?: boolean): void;
/**
 * @param {Workbook} context - Specifies context
 ...
 * @hidden
 */
export declare function duplicateSheet(context: Workbook, sheetIndex?: number, action?: boolean): void;
