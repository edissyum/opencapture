...
.e-spreadsheet .e-sheet-tab.e-tab .e-tab-header .e-toolbar-item:not(.e-separator).e-active .e-text-wrap,
...
.e-ribbon .e-tab .e-tab-header .e-toolbar-item:not(.e-separator).e-active .e-text-wrap,
...
.e-ribbon .e-tab-header .e-menu-wrapper.e-file-menu ul.e-menu {
  font-size: 14px;
}

.e-ribbon .e-content .e-toolbar {
  border-color: transparent;
}

.e-ribbon .e-content .e-toolbar .e-toolbar-items .e-toolbar-item.e-overlay {
  opacity: .5;
}
...
.e-bigger .e-ribbon .e-tab .e-tab-header .e-toolbar-item:not(.e-separator).e-active .e-text-wrap,
