...
let Dialog = class Dialog extends Component {
    ...
    getFocusElement(target) {
        let value = 'input,select,textarea,button:enabled,a,[contenteditable="true"],[tabindex]';
        let items = target.querySelectorAll(value);
...
let Tooltip = class Tooltip extends Component {
    ...
    checkCollision(target, x, y) {
        ...
        let affectedPos = isCollide(this.tooltipEle, this.checkCollideTarget(), x, y);
    ...
    collisionFlipFit(target, x, y) {
        ...
        let left = fit(this.tooltipEle, this.checkCollideTarget(), { X: true, Y: false }, eleOffset).left;
        this.tooltipEle.style.display = 'block';
