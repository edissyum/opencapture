...
@include export-module('FileManager-layout') {
  ...
  .e-filemanager {
    ...
    .e-toolbar {
      ...
      .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn {
        ...
        .e-btn-icon.e-icons.e-caret {
          ...
          @if $fm-skin-name == 'tailwind' or $fm-skin-name == 'tailwind-dark' {
            height: 18px;
            margin: 2px 4px 0;
            padding: 1px;
            width: 18px;
    ...
    .e-treeview {
      ...
      & > .e-ul {
        overflow: initial;
        @if $fm-skin-name != 'tailwind' and $fm-skin-name != 'tailwind-dark' {
          padding-left: 8px;
        }
      }
    ...
    .e-large-icons {
      ...
      .e-list-item {
        ...
        @if $fm-skin-name == 'bootstrap4' or $fm-skin-name == 'bootstrap-dark' or $fm-skin-name == 'tailwind' or $fm-skin-name == 'tailwind-dark' {
          border-radius: 4px;
        }
