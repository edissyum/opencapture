...
.e-pv-custom-annotation-stamp-container.e-menu-container ul .e-menu-item.e-selected .e-menu-icon,
.e-pv-custom-annotation-stamp-container.e-menu-container ul .e-menu-item.e-selected .e-caret {
  color: #fff;
}
