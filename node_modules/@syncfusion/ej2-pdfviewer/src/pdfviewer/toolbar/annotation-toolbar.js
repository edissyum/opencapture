...
var AnnotationToolbar = /** @class */ (function () {
            ...
            var propertyToolbar = new Tool({
                ...
                created: function () {
                    ...
                    if (_this.pdfViewer.annotationModule.textMarkupAnnotationModule.currentTextMarkupAnnotation) {
                        id = _this.pdfViewer.element.id + '_underlineIcon';
                    }
                    else if (_this.pdfViewer.selectedItems.annotations[0].shapeAnnotationType === 'FreeText') {
                        id = _this.pdfViewer.element.id + '_annotation_freeTextEdit';
                        // eslint-disable-next-line max-len
                    }
                        ...
                        id = _this.pdfViewer.element.id + '_annotation_stamp';
                        // eslint-disable-next-line max-len
                    }
                    else if (_this.pdfViewer.selectedItems.annotations[0].shapeAnnotationType === 'HandWrittenSignature') {
                        id = _this.pdfViewer.element.id + '_annotation_handwrittenSign';
                    }
                        ...
                        id = _this.pdfViewer.element.id + '_annotation_inkIcon';
                    }
                    else if (shapeType === 'Highlight' || shapeType === 'Underline' || shapeType === 'Strikethrough') {
                        id = _this.pdfViewer.element.id + '_highlightIcon';
                    }
                    else {
                        id = _this.pdfViewer.element.id + '_annotation_shapesIcon';
                    }
                    _this.pdfViewer.toolbarModule.annotationToolbarModule.mobileColorpicker(id);
                }
            });
    ...
    AnnotationToolbar.prototype.showPropertyTool = function (existingTool) {
        if (this.toolbar) {
            this.toolbar.destroy();
        }
    ...
    AnnotationToolbar.prototype.getTemplate = function (elementName, id, className) {
        var element = createElement(elementName, { id: this.pdfViewer.element.id + id, styles: 'text-align:left' });
        if (className) {
