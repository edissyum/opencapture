...
var PdfViewerBase = /** @class */ (function () {
            ...
            if (!_this.getPopupNoteVisibleStatus()) {
                ...
                if (event.button === 0 && !_this.isClickedOnScrollBar(event, false)) {
                    ...
                    if (eventTarget && eventTarget.classList && !eventTarget.classList.contains('e-pv-hyperlink') && !eventTarget.classList.contains('e-pv-page-container')) {
                        ...
                        if (_this.pdfViewer.formFieldsModule) {
        ...
        if (data && this.pageSize[pageIndex]) {
            ...
            if (pageDiv_1) {
                if (this.isMixedSizeDocument && this.highestWidth > 0) {
                    ...
                    pageDiv_1.style.width = pageWidth_1 + 'px';
                }
                pageDiv_1.style.height = pageHeight_1 + 'px';
            ...
            if (canvas) {
                ...
                var currentString = this.documentId + '_' + pageIndex + '_' + zoomFactor_1 + '_' + data.tileX + '_' + data.tileY;
                // eslint-disable-next-line max-len
                ...
                if (imageData) {
                    ...
                    image_1.onload = function () {
                        ...
                        var renderTileCanvas = _this.renderTileCanvas(pageWidth_1, pageHeight_1, pageIndex, pageDiv_1, zoomFactor_1, scaleFactor);
                        if (pagecanvas) {
                            // eslint-disable-next-line
                            ...
                            if (!isNaN(parseFloat(pagecanvas.style.width)) && pageCanvasWidth !== pageCanvasStyleWidth) {
                                ...
                                if (proxy.isDrawnCompletely && renderTileCanvas) {
                                    renderTileCanvas.style.width = pageWidth_1 + 'px';
                                    renderTileCanvas.style.height = pageHeight_1 + 'px';
                                    renderTileCanvas.style.display = "block";
                                    pagecanvas.style.display = 'none';
                                }
                                else {
                                    renderTileCanvas.height = parseInt((pageHeight_1 * scaleFactor).toString());
                                    // tslint:disable-next-line
                                    renderTileCanvas.width = parseInt((pageWidth_1 * scaleFactor).toString());
                                }
                                // eslint-disable-next-line
                            ...
                            var zoomFactor_2 = _this.retrieveCurrentZoomFactor();
                            if (data.zoomFactor) {
                                zoomFactor_2 = data.zoomFactor;
                            }
                            var matrix0 = (matrix_1.Elements[0] * _this.getZoomFactor()) / zoomFactor_2;
                            var matrix1 = (matrix_1.Elements[1] * _this.getZoomFactor()) / zoomFactor_2;
                            var matrix2 = (matrix_1.Elements[2] * _this.getZoomFactor()) / zoomFactor_2;
                            var matrix3 = (matrix_1.Elements[3] * _this.getZoomFactor()) / zoomFactor_2;
                            var matrix4 = (matrix_1.Elements[4] * _this.getZoomFactor()) / zoomFactor_2;
                            var matrix5 = (matrix_1.Elements[5] * _this.getZoomFactor()) / zoomFactor_2;
                            ...
                            if (!proxy.isDrawnCompletely && renderTileCanvas) {
                                var tileContext = renderTileCanvas.getContext('2d');
                                // tslint:disable-next-line
                                tileContext.setTransform(matrix0, matrix1, matrix2, matrix3, matrix4, matrix5);
                                tileContext.drawImage(image_1, 0, 0);
                            }
    ...
    PdfViewerBase.prototype.renderPage = function (data, pageIndex) {
        ...
        if (data && this.pageSize[pageIndex]) {
            ...
            if (pageDiv_2) {
                if (this.isMixedSizeDocument && this.highestWidth > 0) {
                    pageDiv_2.style.width = (this.highestWidth * this.getZoomFactor()) + 'px';
                }
                else {
                    pageDiv_2.style.width = pageWidth_2 + 'px';
                }
                pageDiv_2.style.height = pageHeight_2 + 'px';
                ...
                if (imageData) {
                    ...
                    image_2.onload = function () {
                        ...
                        if (parseInt((pageWidth_2 * scaleFactor).toString()) === parseInt(imageWidth.toString())) {
                            ...
                            if (pageWidth_2 < parseFloat(pageDiv_2.style.width)) {
        ...
        if (this.pageSize && this.pageSize[pageIndex]) {
            ...
            if (canvas) {
                ...
                if (data && data.uniqueId === proxy.documentId) {
                    ...
                    if (zoomFactor_3 > 2 && pageWidth_3 <= 1200) {
                        viewPortWidth_1 = 700;
                    }
                    else {
                    ...
                    if ((viewPortWidth_1 >= pageWidth_3) || !proxy.pdfViewer.tileRenderingSettings.enableTileRendering) {
                        ...
                        for (var k = 0; k < noTileX; k++) {
                            for (var l = 0; l < noTileY; l++) {
                                ...
                                data = JSON.parse(this.getWindowSessionStorageTile(pageIndex, k, l, zoomFactor_3));
                                if (data) {
                                    proxy.tileRenderPage(data, pageIndex);
                                }
                            }
                    ...
                    for (var x = 0; x < noTileX; x++) {
                        for (var y = 0; y < noTileY; y++) {
                            var jsonObject = null;
                            var zoomFactor_4 = this.retrieveCurrentZoomFactor();
                            if (zoomFactor_4 > 2 && pageWidth_3 <= 1200) {
                                viewPortWidth_1 = 700;
                            }
                            else {
                                viewPortWidth_1 = 1200;
                            ...
                            jsonObject = {
                                ...
                                // eslint-disable-next-line max-len
                                zoomFactor: zoomFactor_4, action: 'RenderPdfPages', uniqueId: this.documentId, elementId: proxy.pdfViewer.element.id
                            };
                            if (this.jsonDocumentId) {
                                // eslint-disable-next-line
                                jsonObject.documentId = this.jsonDocumentId;
                            ...
                            proxy.requestLists.push(proxy.documentId + '_' + pageIndex + '_' + x + '_' + y + '_' + zoomFactor_4);
                            // eslint-disable-next-line
                            proxy.pageRequestHandler.onSuccess = function (result) {
                                ...
                                if (data) {
                                    ...
                                    if (data.image && data.uniqueId === proxy.documentId) {
                                        var currentPageWidth = (data.pageWidth && data.pageWidth > 0) ? data.pageWidth : pageWidth_3;
            ...
            if (freeTextAnnotModule.isNewFreeTextAnnot === true && !(currentObj && currentObj.shapeAnnotationType === 'FreeText')) {
                ...
                if (evt.target && (evt.target.id.indexOf('_text') > -1 || evt.target.id.indexOf('_annotationCanvas') > -1 || evt.target.classList.contains('e-pv-hyperlink')) && this.pdfViewer.annotation) {
                    ...
                    if (diagram) {
                        ...
                        canvas = new Rect(left + 10, top_4 + 10, canvas1.width - 10, canvas1.height - 10);
                    }
                }
                if (touches) {
