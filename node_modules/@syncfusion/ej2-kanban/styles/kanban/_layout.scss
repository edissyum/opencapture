      ...
      .e-frozen-row {
        ...
        .e-swimlane-header {
          ...
          .e-swimlane-row-collapse {
            ...
            @if ($kanban-skin == 'fabric' or $kanban-skin == 'fabric-dark') {
              padding: 4px 6px;
            }
            ...
            &:focus {
              ...
              @if ($kanban-skin == 'bootstrap5') {
                background: $kanban-collapse-icon-bg-color;
                color: $kanban-collapse-icon-color;
                font-size: $text-sm;
                margin: 1px;
                padding: 2px;
              }
            ...
            &:focus {
              @if ($kanban-skin == 'bootstrap5') {
                box-shadow: $kanban-collapse-icon-action-box-shadow-boot5;
              }
            }
          }
        }
