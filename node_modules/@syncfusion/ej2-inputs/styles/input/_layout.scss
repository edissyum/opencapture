@include export-module('input-layout') {
  ...
  .e-input-group.e-control-wrapper.e-small {
    @if ($input-skin-name == 'tailwind' or $input-skin-name == 'tailwind-dark') {
  ...
  .e-input-group.e-control-wrapper .e-input-group-icon:first-child {
    @if ($input-skin-name == 'bootstrap' or $input-skin-name == 'bootstrap4' or $input-skin-name == 'tailwind' or $input-skin-name == 'tailwind-dark') {
      border-left-width: $zero-value;
    }
  }
  ...
  .e-input-group .e-input-group-icon:first-child,
  .e-input-group.e-control-wrapper .e-input-group-icon:first-child {
    @if ($input-skin-name != 'bootstrap' and $input-skin-name != 'bootstrap4' and $input-skin-name != 'tailwind' and $input-skin-name != 'tailwind-dark') {
  ...
  .e-input-group.e-rtl .e-input-group-icon:last-child,
  .e-input-group.e-control-wrapper.e-rtl .e-input-group-icon:last-child {
    @if ($input-skin-name != 'bootstrap' and $input-skin-name != 'bootstrap4' and $input-skin-name != 'tailwind' and $input-skin-name != 'tailwind-dark') or $input-skin-name == 'highcontrast' {
      border-left-width: $input-border-left-width;
      border-right-width: $zero-value;
    }
  }
  ...
  .e-float-input.e-input-focus input ~ label.e-float-text {
    ...
    @else if ($input-skin-name == 'tailwind' or $input-skin-name == 'tailwind-dark') {
      font-weight: 500;
      padding-right: 0;
  ...
  .e-bigger .e-float-input.e-control-wrapper.e-input-focus input ~ label.e-float-text {
    ...
    @else if $input-skin-name == 'fabric' or $input-skin-name == 'bootstrap' or $input-skin-name == 'bootstrap4' or $input-skin-name == 'highcontrast' or $input-skin-name == 'tailwind' or $input-skin-name == 'tailwind-dark' {
      padding-right: 0;
      top: 14px;
    }
  }
  ...
  .e-float-input.e-bigger.e-small textarea:focus {
    @if $input-skin-name == 'tailwind' or $input-skin-name == 'tailwind-dark' {
      box-shadow: $imput-group-focus-box-shadow;
    }
  }
  ...
  .e-float-input.e-control-wrapper .e-input-in-wrap {
    width: 100%;
    @if $input-skin-name == 'fabric' or $input-skin-name == 'bootstrap' or $input-skin-name == 'bootstrap4' or $input-skin-name == 'highcontrast' or $input-skin-name == 'tailwind' or $input-skin-name == 'tailwind-dark' {
      display: flex;
      position: relative;
    }
  }
