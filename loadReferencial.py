            ...
            if not any(str(taxe_number) in value['vat_number'] for value in list_existing_supplier):
                ...
                args = {
                    ...
                    'columns': {
                        ...
                        'iban': str(spreadsheet.referencialSupplierData[taxe_number][0][spreadsheet.referencialSupplierArray['IBAN']]),
                        ...
                        'company_type': company_type if company_type not in ['nan', None, 'None'] else 'supplier'
                    }
                }
