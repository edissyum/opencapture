...
if [ $pythonVenv = 'true' ]; then
    ...
    "/home/$user/python-venv/opencapture/bin/python3" -m pip install -r "$OpenCapturePath/bin/install/pip-requirements.txt" >>$INFOLOG_PATH 2>>$ERRORLOG_PATH
    "/home/$user/python-venv/opencapture/bin/python3" -m pip install --upgrade -r "$OpenCapturePath/bin/install/pip-requirements.txt" >>$INFOLOG_PATH 2>>$ERRORLOG_PATH
