        ...
        <?php
            ...
            if ($customCpt == 0) {
                ...
                <span>
                    ...
                    <a target="_blank" rel="noopener" href="https://edissyum.gitbook.io/open-capture/technique/installation/creation-dinstances-supplementaires">documentation officielle</a>
                    pour en créer une.
                </span>
                <?php
            }
