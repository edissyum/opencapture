...
if 'config' not in custom_array or 'classes' not in custom_array['Config']['path']:
...
if 'log' not in custom_array or 'classes' not in custom_array['Log']['path']:
...
if 'mail' not in custom_array or 'classes' not in custom_array['Mail']['path']:
...
if 'files' not in custom_array or 'classes' not in custom_array['Files']['path']:
...
if 'MEMWebServices' not in custom_array or 'classes' not in custom_array['MEMWebServices']['path']:
...
if 'database' not in custom_array or 'classes' not in custom_array['Database']['path']:
...
if 'Splitter' not in custom_array or 'classes' not in custom_array['Splitter']['path']:
...
if 'SeparatorQR' not in custom_array or 'classes' not in custom_array['SeparatorQR']['path']:
...
if 'Spreadsheet' not in custom_array or 'classes' not in custom_array['Spreadsheet']['path']:
...
if 'SMTP' not in custom_array or 'classes' not in custom_array['SMTP']['path']:
...
if 'ArtificialIntelligence' not in custom_array or 'classes' not in custom_array['ArtificialIntelligence']['path']:
