...
if 'user' not in custom_array or 'models' not in custom_array['user']['path']:
...
if 'mailcollect' not in custom_array or 'models' not in custom_array['mailcollect']['path']:
...
if 'roles' not in custom_array or 'models' not in custom_array['roles']['path']:
...
if 'forms' not in custom_array or 'models' not in custom_array['forms']['path']:
...
if 'positions_masks' not in custom_array or 'models' not in custom_array['positions_masks']['path']:
...
if 'splitter' not in custom_array or 'models' not in custom_array['splitter']['path']:
...
if 'accounts' not in custom_array or 'models' not in custom_array['accounts']['path']:
...
if 'history' not in custom_array or 'models' not in custom_array['history']['path']:
...
if 'config' not in custom_array or 'models' not in custom_array['config']['path']:
...
if 'verifier' not in custom_array or 'models' not in custom_array['verifier']['path']:
...
if 'status' not in custom_array or 'models' not in custom_array['status']['path']:
...
if 'privileges' not in custom_array or 'models' not in custom_array['privileges']['path']:
...
if 'custom_fields' not in custom_array or 'models' not in custom_array['custom_fields']['path']:
...
if 'outputs' not in custom_array or 'models' not in custom_array['outputs']['path']:
...
if 'doctypes' not in custom_array or 'models' not in custom_array['doctypes']['path']:
...
if 'artificial_intelligence' not in custom_array or 'models' not in custom_array['artificial_intelligence']['path']:
