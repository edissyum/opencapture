...
INSERT INTO "outputs_types" ("id", output_type_id, "output_type_label", "data", "module") VALUES (5, 'export_alfresco', 'Export Alfresco', '{"options": {"auth": [{"id": "cmis_ws", "type": "text", "label": "CMIS Web-Service", "required": "true", "placeholder": "http://localhost//alfresco/api/-default-/public/cmis/versions/1.1/browser"}, {"id": "folder", "type": "text", "label": "Répertoire de dépôt", "required": "true", "placeholder": "/OpenCapture/PMI/scans/"}, {"id": "login", "type": "text", "label": "Pseudo de l''''utilisateur WS", "required": "true", "placeholder": "edissyumws"}, {"id": "password", "type": "password", "label": "Mot de passe de l''''utilisateur WS", "required": "true", "placeholder": "alfresco"}]}}', 'splitter');

INSERT INTO "outputs" ("id", "output_type_id", "output_label", "data", "module") VALUES (3, 'export_pdf', 'Export PDF par défaut', '{"options": {"auth": [], "parameters": [{"id": "folder_out", "type": "text", "value": "/var/share/export/splitter/"}, {"id": "filename", "type": "textarea", "value": "PDF#nom_usage#prenom#doctype#date"}, {"id": "separator", "type": "text", "value": "_"}, {"id": "extension", "type": "text", "value": "pdf"}]}}', 'splitter');
INSERT INTO "outputs" ("id", "output_type_id", "output_label", "data", "module") VALUES (4, 'export_xml', 'Export XML par défaut', '{"options": {"auth": [], "parameters": [{"id": "folder_out", "type": "text", "value": "/var/share/export/splitter/"}, {"id": "filename", "type": "textarea", "value": "XML#nom_usage#date"}, {"id": "separator", "type": "text", "value": "_"}, {"id": "extension", "type": "text", "value": "xml"}]}}', 'splitter');
INSERT INTO "outputs" ("id", "output_type_id", "output_label", "data", "module") VALUES (5, 'export_alfresco', 'Export Alfresco par défaut', '{"options": {"auth": [{"id": "cmis_ws", "type": "text", "value": ""}, {"id": "folder", "type": "text", "value": ""}, {"id": "login", "type": "text", "value": ""}, {"id": "password", "type": "password", "value": ""}], "parameters": []}}', 'splitter');
ALTER SEQUENCE "outputs_types_id_seq" RESTART WITH 6;
ALTER SEQUENCE "outputs_id_seq" RESTART WITH 6;

-- CRÉATION DU FORMMULAIRE VERIFIER PAR DÉFAUT
INSERT INTO "form_models" (id, label, default_form, enabled, outputs, module) VALUES (1, 'Formulaire par défaut', true, true, '{1}', 'verifier');
INSERT INTO "form_models_field" (id, form_id, fields) VALUES (1, 1, '{"other": [], "supplier": [{"id": "name", "type": "text", "unit": "supplier", "class": "w-full", "color": "white", "label": "ACCOUNTS.supplier_name", "format": "alphanum", "display": "simple", "required": true, "class_label": "1", "format_icon": "fas fa-hashtag", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "address1", "type": "text", "unit": "addresses", "class": "w-1/2", "label": "ADDRESSES.address_1", "format": "alphanum_extended_with_accent", "display": "simple", "required": true, "class_label": "1/2", "format_icon": "fas fas fa-hashtag", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "address2", "type": "text", "unit": "addresses", "class": "w-1/2", "label": "ADDRESSES.address_2", "format": "alphanum_extended_with_accent", "display": "simple", "required": false, "class_label": "1/2", "format_icon": "fas fas fa-hashtag", "display_icon": "fas fa-file-alt", "required_icon": "far fa-star"}, {"id": "postal_code", "type": "text", "unit": "addresses", "class": "w-1/3", "label": "ADDRESSES.postal_code", "format": "number_int", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "city", "type": "text", "unit": "addresses", "class": "w-1/3", "label": "ADDRESSES.city", "format": "char", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "fas fa-font", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "country", "type": "text", "unit": "addresses", "class": "w-1/3", "label": "ADDRESSES.country", "format": "char", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "fas fa-font", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "vat_number", "type": "text", "unit": "supplier", "class": "w-1/3", "color": "olive", "label": "ACCOUNTS.vat_number", "format": "alphanum", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "fas fas fa-hashtag", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "siren", "type": "text", "unit": "supplier", "class": "w-1/3", "color": "lime", "label": "ACCOUNTS.siren", "format": "number_int", "display": "simple", "required": false, "class_label": "1/33", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-file-alt", "required_icon": "far fa-star"}, {"id": "siret", "type": "text", "unit": "supplier", "class": "w-1/3", "color": "green", "label": "ACCOUNTS.siret", "format": "number_int", "display": "simple", "required": false, "class_label": "1/33", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-file-alt", "required_icon": "far fa-star"}], "facturation": [{"id": "delivery_number", "type": "text", "unit": "facturation", "class": "w-1/2", "color": "orange", "label": "FACTURATION.delivery_number", "format": "alphanum_extended", "display": "multi", "required": false, "class_label": "1/2", "format_icon": "fas fa-hashtag fa-level-up-alt", "display_icon": "fas fa-layer-group", "required_icon": "far fa-star"}, {"id": "order_number", "type": "text", "unit": "facturation", "class": "w-1/2", "color": "yellow", "label": "FACTURATION.order_number", "format": "alphanum_extended", "display": "multi", "required": false, "class_label": "1/2", "format_icon": "fas fa-hashtag fa-level-up-alt", "display_icon": "fas fa-layer-group", "required_icon": "far fa-star"}, {"id": "invoice_number", "type": "text", "unit": "facturation", "class": "w-1/3", "color": "red", "label": "FACTURATION.invoice_number", "format": "alphanum_extended", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "fas fa-level-up-alt", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "invoice_date", "type": "date", "unit": "facturation", "class": "w-1/3", "color": "aqua", "label": "FACTURATION.invoice_date", "format": "date", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "fas fa-calendar-day", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "invoice_due_date", "type": "date", "unit": "facturation", "class": "w-1/3", "color": "blue", "label": "FACTURATION.invoice_due_date", "format": "date", "display": "simple", "required": false, "class_label": "1/33", "format_icon": "fas fa-calendar-day", "display_icon": "fas fa-file-alt", "required_icon": "far fa-star"}, {"id": "vat_rate", "type": "text", "unit": "facturation", "class": "w-1/4", "color": "pink", "label": "FACTURATION.vat_rate", "format": "number_float", "display": "multi", "required": true, "class_label": "1/4", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-layer-group", "required_icon": "fas fa-star"}, {"id": "no_rate_amount", "type": "text", "unit": "facturation", "class": "w-1/4", "color": "fuchsia", "label": "FACTURATION.no_rate_amount", "format": "number_float", "display": "multi", "required": true, "class_label": "1/4", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-layer-group", "required_icon": "fas fa-star"}, {"id": "vat_amount", "type": "text", "unit": "facturation", "class": "w-1/4", "color": "purple", "label": "FACTURATION.vat_amount", "format": "number_float", "display": "multi", "required": true, "class_label": "1/4", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-layer-group", "required_icon": "fas fa-star"}, {"id": "accounting_plan", "type": "select", "unit": "facturation", "class": "w-1/4", "label": "FACTURATION.accounting_plan", "required": false, "class_label": "1/4", "required_icon": "far fa-star"}, {"id": "total_vat", "type": "text", "unit": "facturation", "class": "w-1/3", "color": "", "label": "FACTURATION.total_vat", "format": "number_float", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "total_ttc", "type": "text", "unit": "facturation", "class": "w-1/3", "label": "FACTURATION.total_ttc", "format": "number_float", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}, {"id": "total_ht", "type": "text", "unit": "facturation", "class": "w-1/3", "label": "FACTURATION.total_ht", "format": "number_float", "display": "simple", "required": true, "class_label": "1/33", "format_icon": "text-lg icomoon-numbers", "display_icon": "fas fa-file-alt", "required_icon": "fas fa-star"}]}');

-- CRÉATION DU FORMMULAIRE SPLITTER PAR DÉFAUT
INSERT INTO "form_models" (id, label, default_form, outputs, module) VALUES (2, 'Formulaire par défaut', true, '{4}', 'splitter');
INSERT INTO "form_models_field" (id, form_id, fields) VALUES (2, 2, '{"metadata": [{"id": "custom_3", "type": "text", "unit": "custom", "class": "w-1/3", "label": "Prénom", "format": "text", "class_label": "1/33", "label_short": "prenom", "metadata_key": "prenom"}, {"id": "custom_8", "type": "text", "unit": "custom", "class": "w-1/3", "label": "Matricule", "format": "text", "class_label": "1/33", "label_short": "matricule", "metadata_key": "matricule"}, {"id": "custom_4", "type": "text", "unit": "custom", "class": "w-1/3", "label": "Année", "format": "text", "class_label": "1/33", "label_short": "date", "metadata_key": ""}, {"id": "custom_2", "type": "text", "unit": "custom", "class": "w-1/3", "label": "Contrat", "format": "text", "class_label": "1/33", "label_short": "contrat", "metadata_key": "contrat"}, {"id": "custom_6", "type": "text", "unit": "custom", "class": "w-1/3", "label": "Nom d''usage", "format": "text", "class_label": "1/33", "label_short": "nom_usage", "metadata_key": "nom_usage"}]}');
...
INSERT INTO "inputs" ("id", "input_id", "input_label", "default_form_id", "input_folder", "module") VALUES (1, 'default_input', 'Chaîne entrante par défaut', 1, '/var/share/entrant/verifier/', 'verifier');
INSERT INTO "inputs" ("id", "input_id", "input_label", "default_form_id", "input_folder", "module") VALUES (2, 'default_input', 'Chaîne entrante par défaut', 2, '/var/share/entrant/splitter/', 'splitter');
