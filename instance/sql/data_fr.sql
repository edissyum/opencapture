...
INSERT INTO "workflows" ("id", "workflow_id", "label", "module", "input", "process", "separation", "output") VALUES (3, 'default_workflow', 'Workflow par défaut', 'splitter', '{"ai_model_id": null, "customer_id": 1, "input_folder": "/var/share/entrant/splitter/", "apply_process": true}', '{"form_id": 3, "rotation": "no_rotation", "use_interface": true, "delete_documents": false, "allow_automatic_validation": true}', '{"remove_blank_pages": true, "splitter_method_id": "qr_code_OC", "separate_by_document_number_value": 2}', '{"outputs_id": []}');
