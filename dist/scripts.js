...
(function($) {
    $.imageArea = function(parent, id) {
        ...
        $outline = $("<div id='select-areas-outline_" + getData().id + "'  class=\"select-areas-outline\"/>")
            .css({
        ...
        $selection = $("<div />")
            ...
            .attr('id', "select-areas-background-area_" + getData().id)
            .css({
                position : "absolute"
            })
            .insertAfter($outline);

        $label = $("<div id='select-areas-label-container_" + getData().id + "'  class=\"select-areas-label-container\"/>")
            .css({
                position : "absolute"
            })
            .insertAfter($trigger);
        ...
        if (options.allowDelete) {
            ...
            $btDelete = bindToDelete($("<div id='select-areas-delete_" + getData().id + "'  class=\"delete-area\" />"))
                .append(bindToDelete($("<div class=\"select-areas-delete-area\" ><i class=\"fa fa-trash text-red-500 \" aria-hidden=\"true\"></i></div>")))
                .insertAfter($selection);
        }
