...
if 'db' not in custom_array:
    from webApp.controllers import db
else:
...
if 'pdf' not in custom_array:
    from webApp.controllers import pdf
else:
...
if 'auth' not in custom_array:
    from webApp.controllers import auth
else:
...
if 'user' not in custom_array:
    from webApp.controllers import user
else:
...
if 'supplier' not in custom_array:
    from webApp.controllers import supplier
else:
